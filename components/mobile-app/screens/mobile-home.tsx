...
import { Shield, Search, Camera, Mic, History, TrendingUp, Bell, Menu, Plus, Zap } from "lucide-react"
...
const recentChecks = [
  { claim: "Does chocolate cure depression?", verdict: "MISLEADING", time: "2h ago" },
  { claim: "Is climate change caused by humans?", verdict: "TRUE", time: "1d ago" },
  { claim: "Do vaccines cause autism?", verdict: "FALSE", time: "2d ago" },
]

export function MobileHome({ onNavigate, onFactCheck, onBack }: MobileHomeProps) {
      ...
      <div className="bg-white border-b px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-lg">OLA.AI</span>
          </div>
        </div>
        <div className="flex items-center gap-2">
      ...
      <div className="flex-1 overflow-y-auto pb-20">
            ...
            <CardContent className="p-4">
              <div className="space-y-3">
                ...
                <div className="flex gap-2">
                  <Button onClick={handleSubmit} disabled={!query.trim()} className="flex-1">
              ...
              <Card key={index} className="cursor-pointer hover:bg-slate-50">
                <CardContent className="p-3">
                  <div className="flex items-center justify-between">
                    ...
                    <Button variant="ghost" size="sm" onClick={() => handleQuickCheck(claim)}>
                ...
                <CardContent className="p-3">
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex-1">
                      <p className="text-sm font-medium line-clamp-2 mb-1">{check.claim}</p>
        ...
        <div className="px-4 mb-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Button variant="outline" className="h-20 flex-col gap-2" onClick={() => onNavigate("fact-check")}>
              <Plus className="h-6 w-6" />
              <span className="text-sm">New Check</span>
            </Button>
            <Button variant="outline" className="h-20 flex-col gap-2" onClick={() => onNavigate("history")}>
