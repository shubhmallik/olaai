      ...
      <header className="border-b bg-white/80 backdrop-blur-sm">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-2xl font-bold text-slate-800">OlaAI.com</span>
          </div>
          {/* In the header section, replace the existing nav with: */}
          <nav className="hidden md:flex items-center gap-6">
            {/* Update the navigation links */}
            <button onClick={handleHowItWorksClick} className="text-slate-600 hover:text-slate-800">
              How it works
            </button>
            <button onClick={handleBlogClick} className="text-slate-600 hover:text-slate-800">
              Blog
            </button>
            <button onClick={handleMobileAppClick} className="text-slate-600 hover:text-slate-800">
              Mobile App
            </button>
            <button onClick={handleAboutClick} className="text-slate-600 hover:text-slate-800">
              About
            </button>
            {user ? (
              // In the UserMenu component call, update it to:
              <UserMenu onProfileClick={handleProfileClick} onDashboardClick={handleDashboardClick} />
            ) : (
      ...
      <main className="container mx-auto px-4 py-16">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl text-slate-600 mb-12 max-w-2xl mx-auto">
            Combat misinformation with AI-powered real-time fact-checking. Verify claims instantly against credible
            sources.
          </p>
          ...
          <Card className="max-w-2xl mx-auto mb-12 shadow-lg">
            <CardContent className="p-6">
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Button type="submit" size="lg" className="w-full text-lg py-6" disabled={!query.trim() || isAnalyzing}>
                  {isAnalyzing ? (
                    <div className="flex items-center gap-2">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-left">
            <Card className="p-6">
              ...
              <p className="text-slate-600">
                Get instant fact-checking results by scanning multiple credible news sources simultaneously.
              </p>
            </Card>
            ...
            <Card className="p-6">
              ...
              <p className="text-slate-600">
                Every verdict includes clear evidence with source credibility ratings and timestamps.
              </p>
            </Card>
            ...
            <Card className="p-6">
              ...
              <p className="text-slate-600">
                Advanced AI provides confidence metrics with detailed explanations of verification factors.
              </p>
            </Card>
          </div>
        </div>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
          <Card className="max-w-md mx-4">
            <CardContent className="p-8 text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Analyzing your claim...</h3>
